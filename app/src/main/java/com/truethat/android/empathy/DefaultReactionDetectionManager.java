 ...
 */
public class DefaultReactionDetectionManager implements ReactionDetectionManager {
  /**
   * For logging.
   */
  ...
  public DefaultReactionDetectionManager(EmotionDetectionClassifier detectionClassifier) {
  ...
  @Override public void attempt(Image image) {
    ...
    if (mDetectionPubSub == null) {
      throw new RuntimeException(
          "Attempting to push input without calling ReactionDetectionManager#classify first.");
    }
