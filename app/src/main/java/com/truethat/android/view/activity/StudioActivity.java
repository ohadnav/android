...
public class StudioActivity
    extends MainActivity<StudioViewInterface, StudioViewModel, ActivityStudioBinding>
  ...
  //public static StudioActivity newInstance() {
  //  Bundle args = new Bundle();
  //  StudioActivity fragment = new StudioActivity();
  ...
  @Nullable @Override public ViewModelBindingConfig getViewModelBindingConfig() {
    //return new ViewModelBindingConfig(R.layout.activity_studio, getContext());
  ...
  @Override public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    // Hooks capture button
    //mCaptureButton = getActivity().findViewById(R.id.toolbar_studio);
    mCaptureButton = (ImageButton) findViewById(R.id.toolbar_studio);
    getViewModel().mCaptureButtonDrawableResource.addOnPropertyChangedCallback(
        new Observable.OnPropertyChangedCallback() {
          @Override public void onPropertyChanged(Observable sender, int propertyId) {
            mCaptureButton.setImageResource(getViewModel().mCaptureButtonDrawableResource.get());
