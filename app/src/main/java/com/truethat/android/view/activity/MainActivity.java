...
public abstract class MainActivity<ViewInterface extends BaseViewInterface, ViewModel extends BaseViewModel<ViewInterface>, DataBinding extends ViewDataBinding>
    extends BaseActivity<ViewInterface, ViewModel, DataBinding>
    implements BaseViewInterface, ToolbarViewInterface {
  ...
  //@VisibleForTesting public StudioActivity mStudioFragment;
  //@VisibleForTesting public TheaterActivity mTheaterFragment;
  //@VisibleForTesting public RepertoireActivity mRepertoireFragment;
  ...
  //@VisibleForTesting public StudioActivity getStudioFragment() {
  ...
  @Override public void navigateToRepertoire() {
    ...
    startActivity(new Intent(this, RepertoireActivity.class));
  }
  ...
  @Override public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    //              mRepertoireFragment = RepertoireActivity.newInstance();
  ...
  public void navigateToTheaterInternal() {
  ...
  public void navigateToStudioInternal() {
  ...
  public void navigateToRepertoireInternal() {
