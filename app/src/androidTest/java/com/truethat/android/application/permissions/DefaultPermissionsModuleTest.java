...
@MediumTest
@Ignore // Test fails since shell commands take time to take effect.
public class DefaultPermissionsModuleTest {
    ...
    @Test
    public void isPermissionGranted_shouldBeGranted() throws Exception {
        // Grant permission via shell
        PermissionsTestUtil.grantPermission(PERMISSION);
        // Assert permission check is correct
        assertTrue(
                mPermissionsModule.isPermissionGranted(activityTestRule.getActivity(), PERMISSION));
    }

    @Test
    public void isPermissionGranted_shouldNotBeGranted() throws Exception {
    ...
    @Test
    public void requestIfNeeded_shouldRequest() throws Exception {
        // Revokes permission via shell
        PermissionsTestUtil.revokePermission(PERMISSION);
        ...
        assertNotEquals(PackageManager.PERMISSION_GRANTED, ActivityCompat.checkSelfPermission(
                activityTestRule.getActivity(), PERMISSION.getManifest()));
    }

    @Test
    public void requestIfNeeded_alreadyHadPermission() throws Exception {
        // Revokes permission via shell
        PermissionsTestUtil.grantPermission(PERMISSION);
        mPermissionsModule.requestIfNeeded(activityTestRule.getActivity(), PERMISSION);
        ...
        assertEquals(PackageManager.PERMISSION_GRANTED, ActivityCompat.checkSelfPermission(
                activityTestRule.getActivity(), PERMISSION.getManifest()));
    }

    @Test
    public void shouldShowRationale() throws Exception {
        // Revokes permission via shell
        PermissionsTestUtil.revokePermission(PERMISSION);
        mPermissionsModule.requestIfNeeded(activityTestRule.getActivity(), PERMISSION);
        // Assert permission dialogue is prompted
        ...
        assertTrue(
                mPermissionsModule.shouldShowRationale(activityTestRule.getActivity(), PERMISSION));
