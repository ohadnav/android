...
public class MockPermissionsModule implements PermissionsModule {
    ...
    public boolean isPermissionGranted(Context context, Permission permission) {
        return mPermissionToIsGranted.containsKey(permission) && mPermissionToIsGranted
                .get(permission);
    }

    @Override
    public boolean shouldShowRationale(Activity activity, Permission permission) {
    ...
    @Override
    public void requestIfNeeded(@Nullable Activity activity, Permission permission) {
        ...
        if (activity != null) {
            activity.onRequestPermissionsResult(
                    permission.getRequestCode(), new String[]{permission.getManifest()},
                    new int[]{isPermissionGranted(activity, permission) ?
