 ...
 */
public class DefaultReactionDetectionManagerTest extends BaseApplicationTestSuite {
  private static final long REQUEST_INPUT_TIMEOUT_MILLIS =
      DefaultReactionDetectionManager.REQUEST_INPUT_TIMEOUT_MILLIS;
  private static final long DETECTION_TIMEOUT_MILLIS =
      DefaultReactionDetectionManager.DETECTION_TIMEOUT_MILLIS;
  private static final long TEST_TIMEOUT_MILLIS = 100;
  private Emotion mDetectedReaction;
  private ReactionDetectionManager mDetectionModule;
  private ReactionDetectionPubSub mDetectionPubSub;
  private boolean mFirstInputRequest;

  @BeforeClass public static void beforeClass() throws Exception {
    DefaultReactionDetectionManager.setDetectionTimeoutMillis(TEST_TIMEOUT_MILLIS);
    DefaultReactionDetectionManager.setRequestInputTimeoutMillis(TEST_TIMEOUT_MILLIS / 2);
  }

  @AfterClass public static void afterClass() throws Exception {
    DefaultReactionDetectionManager.setDetectionTimeoutMillis(DETECTION_TIMEOUT_MILLIS);
    DefaultReactionDetectionManager.setRequestInputTimeoutMillis(REQUEST_INPUT_TIMEOUT_MILLIS);
  }
  ...
  @Test public void emotionDetected() throws Exception {
    ...
    mDetectionModule = new DefaultReactionDetectionManager(new EmotionDetectionClassifier() {
